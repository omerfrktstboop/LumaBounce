...
const EVENT_FIELDS := {
	...
	LEVEL_COMPLETE: [&"level_id", &"world", &"stars", &"seconds_bucket", &"shots", &"first_clear", &"is_bonus", &"revived"],
	LEVEL_FAIL: [&"level_id", &"world", &"reason", &"shots_bucket", &"revive_eligible", &"is_bonus"],
